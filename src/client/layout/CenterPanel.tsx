...
export function CenterPanel({
      ...
      <section className="flex-1 overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
        ...
        <div className="max-w-7xl mx-auto px-12 pt-24 pb-16 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#efeeeb] rounded-full mb-8">
            <span
              className="material-symbols-outlined text-[#2a14b4] text-sm"
              style={{ fontVariationSettings: "'FILL' 1" }}
            >
              psychology
            </span>
            <span className="text-xs font-bold tracking-widest text-[#464554] uppercase">
          ...
          <div className="max-w-3xl mx-auto mb-20">
            ...
            <p className="mt-6 text-[#464554] text-sm">
              Enter any GitHub Pull Request URL to start an AI-powered code
              review.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-12 pb-24 grid grid-cols-1 md:grid-cols-12 gap-8">
          <div className="md:col-span-8 bg-[#f5f3f0] rounded-[2.5rem] p-12 relative overflow-hidden">
            <span className="font-body font-bold text-[#2a14b4] tracking-widest uppercase text-[10px] mb-4 block">
              What is Prism
            </span>
            <h2 className="text-4xl font-headline font-bold text-[#1b1c1a] mb-6 max-w-md">
              A last line of defense before merge
            </h2>
            <p className="text-[#464554] text-lg leading-relaxed max-w-lg mb-8">
              Paste a GitHub PR URL and Prism reviews it before it hits main.
              Four specialized agents run in parallel — each focused on a
              different class of problem — so nothing slips through. Use it to
              catch real issues, or as an interactive tool to understand and
            ...
            <div className="flex gap-4 flex-wrap">
              <div className="bg-white px-4 py-3 rounded-xl shadow-[0_16px_32px_-4px_rgba(27,28,26,0.04)] flex items-center gap-3">
                <span className="material-symbols-outlined text-[#2a14b4]">
                  shield
                </span>
          ...
          <div className="md:col-span-4 bg-gradient-to-br from-[#2a14b4] to-[#4338ca] p-8 rounded-[2.5rem] text-white flex flex-col justify-between">
            <div>
              ...
              <p className="text-white/80 text-sm leading-relaxed">
                Ask the Prism Assistant about any finding to get an explanation
                or a suggested fix, with full file context injected
                automatically.
              </p>
            </div>
          </div>
          ...
          <div className="md:col-span-4 bg-[#eae8e5] rounded-[2.5rem] p-10">
            <span className="material-symbols-outlined text-[#2a14b4] mb-4 block">
              grid_view
            </span>
            <h4 className="text-xl font-headline font-bold mb-3 text-[#1b1c1a]">
              SOLID & Anti-patterns
            </h4>
            <p className="text-[#464554] text-sm leading-relaxed">
              Flags SOLID violations, high cyclomatic complexity, long
              functions, and naming inconsistencies.
            </p>
          </div>
          <div className="md:col-span-4 bg-white border border-[#c7c4d7]/15 rounded-[2.5rem] p-10 shadow-[0_16px_32px_-4px_rgba(27,28,26,0.04)]">
            ...
            <p className="text-[#464554] text-sm leading-relaxed">
              Scans for injection vulnerabilities, exposed secrets, insecure
              auth flows, and OWASP-class issues.
            </p>
          </div>
          <div className="md:col-span-4 bg-[#f5f3f0] rounded-[2.5rem] p-10">
            ...
            <p className="text-[#464554] text-sm leading-relaxed">
              Every review is stored in D1. The dashboard tracks scores, finding
              trends, and top recurring issues across all your PRs.
            </p>
          </div>
        </div>
      </section>
  ...
  if (stage === "processing") {
    ...
    const progress =
      agents.length > 0 ? Math.round((doneCount / agents.length) * 100) : 0;
        ...
        <div className="max-w-6xl mx-auto px-12 pt-12 pb-12">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
            <div className="max-w-2xl">
              <span className="text-[12px] uppercase tracking-[0.3em] text-[#2a14b4] font-bold mb-4 block">
                System Diagnostic
              </span>
              <h2 className="text-5xl font-headline text-[#1b1c1a] leading-[1.1] mb-6">
                System Analysis in Progress
              </h2>
              <p className="text-[#464554] text-lg leading-relaxed font-light">
                The enabled agents are running in parallel against your diff.
            ...
            <div className="relative flex items-center justify-center shrink-0">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                <span className="text-3xl font-headline text-[#1b1c1a]">
                  {progress}%
                </span>
                <span className="text-[10px] uppercase tracking-widest text-[#777586] font-bold">
                  Aggregated
                </span>
              </div>
            </div>
    ...
    <section className="flex-1 overflow-y-auto p-12 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
      <div className="max-w-5xl mx-auto">
        ...
        <header className="mb-12">
          <h1 className="font-headline text-5xl font-bold mb-8 tracking-tight text-[#1b1c1a]">
            Analysis Results
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="md:col-span-1 bg-white p-8 rounded-[24px] border border-[#c7c4d7]/10 shadow-[0_16px_32px_-4px_rgba(27,28,26,0.04)] flex flex-col items-center justify-center">
              <span className="text-xs font-bold tracking-widest uppercase text-[#464554] mb-2">
                Quality Score
              </span>
              <div className="text-6xl font-headline font-bold text-indigo-700">
                {reviewSummary?.score ?? "—"}
              </div>
            ...
            <div className="md:col-span-3 grid grid-cols-3 gap-6">
              <div className="bg-[#f5f3f0] p-6 rounded-[24px] flex flex-col justify-between">
                <span
                  className="material-symbols-outlined text-[#ba1a1a] text-3xl block mb-2"
                  style={{ fontVariationSettings: "'FILL' 1" }}
                >
                  report
                </span>
                <div>
                  <div className="text-3xl font-headline font-bold text-[#1b1c1a]">
                    {reviewSummary?.critical ?? 0}
                  </div>
                  <div className="text-xs font-semibold text-[#464554] uppercase tracking-wider mt-1">
                    Critical
                  </div>
                </div>
              </div>
              <div className="bg-[#f5f3f0] p-6 rounded-[24px] flex flex-col justify-between">
                <span
                  className="material-symbols-outlined text-amber-600 text-3xl block mb-2"
                  style={{ fontVariationSettings: "'FILL' 1" }}
                >
                  warning
                </span>
              ...
              <div className="bg-[#f5f3f0] p-6 rounded-[24px] flex flex-col justify-between">
                <span
                  className="material-symbols-outlined text-indigo-600 text-3xl block mb-2"
                  style={{ fontVariationSettings: "'FILL' 1" }}
                >
                  lightbulb
                </span>
        ...
        <section className="space-y-6">
          <h2 className="font-headline text-2xl font-semibold border-b border-[#e4e2df] pb-4 text-[#1b1c1a]">
            Detected Findings
          </h2>
          {findings.length === 0 ? (
            ...
            <div className="space-y-6">
              {[...findings]
                .sort((a, b) => {
                  ...
                  return (
                    (priority[a.severity] ?? 4) - (priority[b.severity] ?? 4)
                  );
                })
                .map((finding) => (
                  <FindingCard
                    key={finding.id}
                    finding={finding}
                    onReply={() => onReplyToFinding(finding)}
                  />
                ))}
            </div>
          )}
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-sm uppercase tracking-widest font-bold text-[#464554]">
          Global System Log
        </h3>
      </div>
            ...
            logs.map((entry) => {
              ...
              return (
                <div key={entry.id} className="flex gap-4">
                  ...
                  <span className={`shrink-0 w-24 ${getSourceColor(source)}`}>
                    {source}
                  </span>
