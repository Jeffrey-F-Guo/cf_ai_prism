...
export function ReviewHistoryPage({ reviewHistory, onSelectReview, onDeleteReview }: ReviewHistoryPageProps) {
        ...
        {reviewHistory.length === 0 ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-separate border-spacing-y-4">
              ...
              <tbody>
                {(repoFilter ? reviewHistory.filter(r => `${r.owner}/${r.repo}` === repoFilter) : reviewHistory).map((item) => {
